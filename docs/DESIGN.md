...
> Design notes for **social-checkout-fulfillment** — a runnable python example that Typed Python service connecting social login to a deterministic checkout and fulfillment decision.
...
- **Feature code** — the actual task: social checkout.
